...
\hypertarget{md_docs_tutorials_general_debugging_autotoc_md23}{}\doxysection{Further debug info with $<$tt$>$errno$<$/tt$>$}\label{md_docs_tutorials_general_debugging_autotoc_md23}
...
Debugging in this manner is standard to other environments besides P\+R\+OS. For further information on using {\ttfamily errno}, see the following tutorial\+: \href{https://www.tutorialspoint.com/cprogramming/c_error_handling.htm}{\texttt{ https\+://www.\+tutorialspoint.\+com/cprogramming/c\+\_\+error\+\_\+handling.\+htm}}\hypertarget{md_docs_tutorials_general_debugging_autotoc_md24}{}\doxysection{J\+I\+N\+X Graphical Debugger}\label{md_docs_tutorials_general_debugging_autotoc_md24}
