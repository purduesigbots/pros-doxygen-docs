...
\hypertarget{md_docs_tutorials_topical_adi_autotoc_md30}{}\doxysection{Analog Sensors}\label{md_docs_tutorials_topical_adi_autotoc_md30}
...
Thus an example of use on a lift would look like\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md33}{}\doxysubsection{Line Tracker}\label{md_docs_tutorials_topical_adi_autotoc_md33}
...
An example of Line Tracker use\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md34}{}\doxysubsection{Accelerometer}\label{md_docs_tutorials_topical_adi_autotoc_md34}
...
Example accelerometer use\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md35}{}\doxysection{Digital Sensors}\label{md_docs_tutorials_topical_adi_autotoc_md35}
\hypertarget{md_docs_tutorials_topical_adi_autotoc_md36}{}\doxysubsection{Initialization}\label{md_docs_tutorials_topical_adi_autotoc_md36}
As with all A\+DI sensors, the first step to using the sensor is to set the configuration for its A\+DI port.

From there, using a digital sensor is fairly straightforward. Digital Sensors always return a true or false (boolean) value.\hypertarget{md_docs_tutorials_topical_adi_autotoc_md37}{}\doxysubsection{Quad Encoder}\label{md_docs_tutorials_topical_adi_autotoc_md37}
...
And then used in the following manner\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md38}{}\doxysubsection{Ultrasonic}\label{md_docs_tutorials_topical_adi_autotoc_md38}
...
And then used in the following manner\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md39}{}\doxysubsection{Pneumatics}\label{md_docs_tutorials_topical_adi_autotoc_md39}
