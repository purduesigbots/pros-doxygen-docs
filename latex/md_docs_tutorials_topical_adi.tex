...
\hypertarget{md_docs_tutorials_topical_adi_autotoc_md35}{}\doxysection{Analog Sensors}\label{md_docs_tutorials_topical_adi_autotoc_md35}
...
Thus an example of use on a lift would look like\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md38}{}\doxysubsection{Line Tracker}\label{md_docs_tutorials_topical_adi_autotoc_md38}
...
An example of Line Tracker use\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md39}{}\doxysubsection{Accelerometer}\label{md_docs_tutorials_topical_adi_autotoc_md39}
...
Example accelerometer use\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md40}{}\doxysection{Digital Sensors}\label{md_docs_tutorials_topical_adi_autotoc_md40}
\hypertarget{md_docs_tutorials_topical_adi_autotoc_md41}{}\doxysubsection{Initialization}\label{md_docs_tutorials_topical_adi_autotoc_md41}
As with all A\+DI sensors, the first step to using the sensor is to set the configuration for its A\+DI port.

From there, using a digital sensor is fairly straightforward. Digital Sensors always return a true or false (boolean) value.\hypertarget{md_docs_tutorials_topical_adi_autotoc_md42}{}\doxysubsection{Quad Encoder}\label{md_docs_tutorials_topical_adi_autotoc_md42}
...
And then used in the following manner\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md43}{}\doxysubsection{Ultrasonic}\label{md_docs_tutorials_topical_adi_autotoc_md43}
...
And then used in the following manner\+:\hypertarget{md_docs_tutorials_topical_adi_autotoc_md44}{}\doxysubsection{Pneumatics}\label{md_docs_tutorials_topical_adi_autotoc_md44}
