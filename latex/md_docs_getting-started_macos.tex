There are currently two ways to install P\+R\+OS 3 on mac\+OS. The recommended method uses \href{https://brew.sh/}{\texttt{ Homebrew}}, and the other method involves installing components manually.

\doxysection*{Recommended Method (Homebrew)}
...
\doxysubsection*{Install the C\+LI}
...
\doxysubsection*{Install the Editor}
