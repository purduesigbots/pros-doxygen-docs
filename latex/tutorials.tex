...
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the L\+L\+E\+MU, see its C A\+PI and C++ A\+PI.
\end{DoxyNote}
...
\DoxyCodeLine{  \mbox{\hyperlink{classpros_1_1v5_1_1Motor}{pros::Motor}} drive\_left (MOTOR\_PORT);}
...
\item It was mentioned above, but it\textquotesingle{}s important enough for a second mention\+: every tasks\textquotesingle{} loop should have a {\ttfamily \mbox{\hyperlink{group__c-optical_ga6a62f5325d65f95436762552df547d73}{delay()}}} statement. 
\end{DoxyItemize}\end{quote}
