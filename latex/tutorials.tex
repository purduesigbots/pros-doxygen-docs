...
\end{DoxyItemize}\hypertarget{coding-faq}{}\doxysection{Coding F\+AQ}\label{coding-faq}
\begin{quote}
...
Task notifications are a powerful new feature in P\+R\+OS 3 which allows direct-\/to-\/task synchronization. A full tutorial on task notifications can be found \href{./notifications.html}{\texttt{ here}}. \hypertarget{vision}{}\doxysection{Vision Sensor}\label{vision}
\begin{DoxyNote}{Note}
