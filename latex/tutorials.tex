...
If you\textquotesingle{}re interested in combining C and C++, you should read through the \href{../general/combining-c-cpp.html}{\texttt{ Combining C and C++ tutorial}}. Please note that it is typically a complicated matter to combine the two, and rarely a good idea. \hypertarget{adi}{}\doxysection{A\+DI (3 Wire Ports)}\label{adi}
\begin{DoxyNote}{Note}
...
Task notifications are a powerful new feature in P\+R\+OS 3 which allows direct-\/to-\/task synchronization. A full tutorial on task notifications can be found \href{./notifications.html}{\texttt{ here}}. \hypertarget{notifications}{}\doxysection{Task Notifications}\label{notifications}
\begin{DoxyNote}{Note}
