...
\end{DoxyItemize}\end{quote}
\hypertarget{clawbot}{}\doxysection{Programming the Clawbot}\label{clawbot}
...
If you\textquotesingle{}re interested in combining C and C++, you should read through the \mbox{\hyperlink{combining-c-cpp}{Combining C and C++}}. Please note that it is typically a complicated matter to combine the two, and rarely a good idea. \hypertarget{adi}{}\doxysection{A\+DI (3 Wire Ports)}\label{adi}
\begin{DoxyNote}{Note}
