...
\DoxyCodeLine{  encoder = \mbox{\hyperlink{namespacepros_1_1c_a15541b0b04422dd2eaa41b0da6fcef40}{adi\_encoder\_init}}(QUAD\_TOP\_PORT, QUAD\_BOTTOM\_PORT, \textcolor{keyword}{false});}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the L\+L\+E\+MU, see its
\end{DoxyNote}
\begin{quote}
C A\+PI and C++ A\+PI. \end{quote}
