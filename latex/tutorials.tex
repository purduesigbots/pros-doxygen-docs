...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} P\+R\+OS tutorials are split into three sections\+:\hypertarget{tutorials_autotoc_md28}{}\doxysection{General Tutorials}\label{tutorials_autotoc_md28}
...
If you want more information about using a particular part of the \mbox{\hyperlink{api}{A\+PI Home}}, the {\bfseries{Topical Tutorials}} offer longer examples and more detail about using the P\+R\+OS A\+PI.
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} P\+R\+OS C and C++ A\+P\+Is cover the exact same feature set, which means that there is no significant advantage to using functions from one A\+PI in another language. However, if you do find yourself wanting to use C A\+PI functions in C++, these functions are accessible through the namespace {\ttfamily \mbox{\hyperlink{namespacepros_1_1c}{pros\+::c}}}.

\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} can also be done by using the {\ttfamily \mbox{\hyperlink{namespacepros_1_1c}{pros\+::c}}} namespace as such\+: \begin{DoxyVerb}using namespace pros::c;
\end{DoxyVerb}
...
{\ttfamily errno} is a global value that is set when any part of the P\+R\+OS kernel encounters an error. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} value of {\ttfamily errno} is specific to each function, so check the function headers or the \href{../../api/index.html}{\texttt{ A\+PI docs}} for possible values and their meaning. If you think you\textquotesingle{}re encountering an error in the kernel code, check the value of {\ttfamily errno} to see what\textquotesingle{}s causing the issue.

Debugging in this manner is standard to other environments besides P\+R\+OS. For further information on using {\ttfamily errno}, see the following tutorial\+: \href{https://www.tutorialspoint.com/cprogramming/c_error_handling.htm}{\texttt{ https\+://www.\+tutorialspoint.\+com/cprogramming/c\+\_\+error\+\_\+handling.\+htm}}\hypertarget{debugging_autotoc_md21}{}\doxyparagraph{J\+I\+N\+X Graphical Debugger}\label{debugging_autotoc_md21}
J\+I\+NX offers further debugging functionality over traditional debugging through print statements. For a full explanation of J\+I\+NX\textquotesingle{}s abilities and its use, see \mbox{\hyperlink{jinx}{J\+I\+NX Graphical Debugger}}. \hypertarget{project-structure}{}\doxysubsection{Project Structure}\label{project-structure}
P\+R\+OS projects are internally composed of three parts\+: the {\bfseries{P\+R\+OS library}} (found in {\ttfamily /firmware}), the {\bfseries{header}} files (found in {\ttfamily /include}), and {\bfseries{user code}} (found in {\ttfamily /src}).\hypertarget{project-structure_autotoc_md22}{}\doxyparagraph{firmware}\label{project-structure_autotoc_md22}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} {\bfseries{P\+R\+OS library}} is a single file containing the core P\+R\+OS routines. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} file does not need to be changed. If there appears to be an issue with a core P\+R\+OS function, please file an issue on \href{https://github.com/purduesigbots/pros/issues}{\texttt{ Git\+Hub}}.\hypertarget{project-structure_autotoc_md23}{}\doxyparagraph{include}\label{project-structure_autotoc_md23}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} {\bfseries{header}} files are all found in the {\ttfamily include} directory. One header file, \href{../../api/index.html}{\texttt{ api.\+h}}, is required to declare the P\+R\+OS library functions. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} file exists merely to include the individual P\+R\+OS A\+PI headers, all of which can be found in {\ttfamily include/pros}. Each header file in this directory covers a specific aspect of interacting with the V5 hardware, and correlates to the files found in the \href{../../api/index.html}{\texttt{ A\+PI documentation}}.

\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} other file, {\ttfamily \mbox{\hyperlink{main_8h}{main.\+h}}}, is intended for declaring functions and variables shared between the user code files. {\ttfamily \mbox{\hyperlink{main_8h}{main.\+h}}} also offers a variety of configurable options for tailoring P\+R\+OS to your needs.
...
\item {\ttfamily using namespace pros}\+: \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} can be uncommented to be added with the use of {\ttfamily P\+R\+O\+S\+\_\+\+U\+S\+E\+\_\+\+S\+I\+M\+P\+L\+E\+\_\+\+N\+A\+M\+ES}. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} reduces the length of declarations when using C++, allowing you to simply declare a {\ttfamily Motor} instead of a {\ttfamily \mbox{\hyperlink{group__cpp-motors_classpros_1_1Motor}{pros\+::\+Motor}}}. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} will make the code appear cleaner and will be simpler for newer programmers, but is typically considered \href{https://msdn.microsoft.com/en-us/library/5cb46ksf.aspx}{\texttt{ bad practice}}. As a result, this line is commented out by default.
\end{DoxyItemize}
...
\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} will ensure that the P\+R\+OS A\+PI and other critical definitions are available in each file.

While more complicated than some environments, splitting up code grants powerful modularity and code reusability, especially when combined with source control. \hypertarget{troubleshooting}{}\doxysubsection{P\+R\+OS Troubleshooting and Common Problems}\label{troubleshooting}
...
\begin{DoxyItemize}
\item {\ttfamily \char`\"{}main.\+h\char`\"{} file not found}\+: \+: \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} error occurs when the compilation database {\ttfamily compile\+\_\+commands.\+json} is not up to date. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} file contains the exact compiler calls of the project, and should be automatically populated when the code is compiled. If you see this error just after creating a project, it could be because the project was created using the C\+LI without the after creating the project. Regardless of when this issue after creating the project. Regardless of when this issue appears, running {\ttfamily pros make all} in the C\+LI or running {\ttfamily P\+R\+OS -\/$>$ Build -\/$>$ All} in the editor, the whole project is compiled again, fixing this issue. You may need to close and reopen any files in order for the linter to catch up. It is also possible that a compilation error was not caught by the linter, so running a full build will help discover these hidden errors. 
...
\item {\bfseries{Neither autonomous nor driver control code starts\+:}} \+: \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} {\ttfamily \mbox{\hyperlink{main_8h_a9efe22aaead3a5e936b5df459de02eba}{initialize()}}} function may still be running. Some tasks such as \href{../../api/c/adi.html\#analog-calibrate}{\texttt{ analog\+\_\+calibrate}} take time. \begin{DoxyVerb}If the `initialize()` function implements some type of loop or
...
\end{DoxyItemize}
\item {\bfseries{Cortex blinking red light after upload\+:}} \+: Turn the Cortex microcontroller off and on again. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} usually resolves the problem, and it is generally good practice to re-\/initialize the robot to simulate conditions at most competitions. If the error persists, see the \char`\"{}$\ast$$\ast$\+Code restarts
...
\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} tutorial will guide you through basic programming of the V\+EX Clawbot.\hypertarget{clawbot_autotoc_md67}{}\doxyparagraph{Intended Audience}\label{clawbot_autotoc_md67}
\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} tutorial is intended for developers with some programming experience, but with little to no experience with the P\+R\+OS library. If you haven\textquotesingle{}t programmed before, we recommend checking out all the \char`\"{}\+Introduction and Basic C Features\char`\"{} sections of \href{http://www.studytonight.com/c/overview-of-c.php}{\texttt{ this tutorial series}}; you may also benefit from the \char`\"{}\+Pointers, Arrays and Strings\char`\"{} sections as well (although they aren\textquotesingle{}t as pertinent).\hypertarget{clawbot_autotoc_md68}{}\doxyparagraph{Goals}\label{clawbot_autotoc_md68}
...
Pick a directory to create the new project in and click Create. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} P\+R\+OS C\+LI will now copy the latest kernel template into the specified directory and Atom will open it.\hypertarget{clawbot_autotoc_md73}{}\doxyparagraph{P\+R\+O\+S Project Structure}\label{clawbot_autotoc_md73}
When you create your project, P\+R\+OS will copy all of the files necessary to build your project. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} structure of the project looks like\+:
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} controller joystick can be read with the following function\+:
...
While tank drive control is perfectly suitable for the driving style of some individuals, it is worth covering the arcade control method as well. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} is similar to the movement style of many video games, where one joystick axis covers forward/backward movement and the other joystick covers turning.

We will take the previous tank drive control code and modify it slightly to become arcade control. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} sum or difference of the power and turn joysticks will be the power values sent to the left and right wheels.
...
Next let\textquotesingle{}s control the clawbot\textquotesingle{}s arm. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} will not require the use of a joystick, but instead we will use the controller\textquotesingle{}s buttons.
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} bump switches, or buttons, are plugged into the A\+DI and attached to the rear of the robot. We\textquotesingle{}ll monitor the status of the bump switches, and prevent the robot from driving backwards if the switches are pressed.
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} autonomous program runs without the use of a controller. We will make a simple autonomous program that drives straight. \hypertarget{creating-c-project}{}\doxysubsection{Creating a C Project}\label{creating-c-project}
...
\end{DoxyWarning}
\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} will compile your P\+R\+OS project as C code, and will give you access to the C A\+PI.
...
\item \mbox{\hyperlink{vision}{Vision Sensor}}
\item \mbox{\hyperlink{wireless-upload}{Wireless Upload and Hot/\+Cold Linking}} 
\end{DoxyItemize}\hypertarget{adi}{}\doxysubsection{A\+DI (3 Wire Ports)}\label{adi}
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the A\+DI, see its \+: \mbox{\hyperlink{group__c-adi}{C A\+PI}} and \mbox{\hyperlink{group__cpp-adi}{C++ A\+PI}}.
\end{DoxyNote}
...
\DoxyCodeLine{  encoder = \mbox{\hyperlink{group__c-adi_gac21579276dee544ecfedd917cfef27e0}{adi\_encoder\_init}}(QUAD\_TOP\_PORT, QUAD\_BOTTOM\_PORT, \textcolor{keyword}{false});}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void} \mbox{\hyperlink{main_8h_a9efe22aaead3a5e936b5df459de02eba}{initialize}}() \{}
\DoxyCodeLine{  ultrasonic = \mbox{\hyperlink{group__c-adi_ga2bd844aa49e221c1e68c0b94d148c3b4}{adi\_ultrasonic\_init}}(ULTRA\_PING\_PORT, ULTRA\_ECHO\_PORT);}
\DoxyCodeLine{\}}
\end{DoxyCode}
...
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the V5 Controller, see its \mbox{\hyperlink{group__c-misc}{C A\+PI}} and \mbox{\hyperlink{group__cpp-misc}{C++ A\+PI}}. Feedback from the V5 Controller comes in two forms -\/ analog and digital. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} analog data comes from the \href{https://en.wikipedia.org/wiki/Analog_stick}{\texttt{ joysticks}}, and the digital data comes from the buttons.
\end{DoxyNote}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} analog data is a value in the range of \mbox{[}-\/127,127\mbox{]}, and digital data is either 1 or 0 (pressed or unpressed, respectively).\hypertarget{controller_autotoc_md41}{}\doxyparagraph{Analog Data}\label{controller_autotoc_md41}
Retrieve analog values from the V5 Controller in the following manner\+:

\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} controller returns a range of \mbox{[}-\/127,127\mbox{]} for analog data, which is why the \href{../../api/c/motors.html\#motor-move}{\texttt{ motor\+\_\+move}} function is appropriate for easy use with the controllers.\hypertarget{controller_autotoc_md42}{}\doxyparagraph{Digital Data}\label{controller_autotoc_md42}
Retrieve Digital Values from the V5 Controller in the following manner\+: \hypertarget{display}{}\doxysubsection{V5 Brain Display (L\+V\+GL)}\label{display}
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} first step to getting started with L\+V\+GL is to include {\ttfamily \mbox{\hyperlink{apix_8h}{pros/apix.\+h}}} in your {\ttfamily \mbox{\hyperlink{main_8h}{main.\+h}}} file or other header files. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} includes the full L\+V\+GL feature set as described in their documentation\+: \href{https://littlevgl.com/}{\texttt{ https\+://littlevgl.\+com/}}
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} only additional detail needed for interacting with the filesystem in P\+R\+OS is that any files on the micro\+SD card {\bfseries{must}} be prefaced with {\ttfamily /usd/}. A file on the micro\+SD card can be written to in the following manner\+:
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} micro\+SD card must be fat32 in order to work.\hypertarget{filesystem_autotoc_md44}{}\doxysubparagraph{Serial}\label{filesystem_autotoc_md44}
...
There are also a number of methods for controlling serial communication behavior exposed in \href{../../extended/apix.html}{\texttt{ apix.\+h}}. These methods can be accessed through the {\ttfamily \mbox{\hyperlink{group__apix_ga16d6c8a8a74f8445db83bedbcb2f35bd}{serctl()}}} function. At the moment two actions are supported -\/activating/deactivating the streams, and enabling/disabling \href{https://en.wikipedia.org/wiki/Consistent_Overhead_Byte_Stuffing}{\texttt{ C\+O\+BS}} . If you want to read the serial comms yourself (without using {\ttfamily pros terminal}), then you\textquotesingle{}ll want to disable C\+O\+BS. \hypertarget{jinx}{}\doxysubsection{J\+I\+NX Graphical Debugger}\label{jinx}
\begin{DoxyWarning}{Warning}
\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} will be completed when J\+I\+NX is finalized for an upcoming minor version increment. 
\end{DoxyWarning}
\hypertarget{llemu}{}\doxysubsection{L\+L\+E\+MU (Legacy L\+CD Emulator)}\label{llemu}
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the L\+L\+E\+MU, see its \mbox{\hyperlink{group__c-llemu}{C A\+PI}} and \mbox{\hyperlink{group__cpp-llemu}{C++ A\+PI}}.
\end{DoxyNote}
...
Initialization is done as such\+:\hypertarget{llemu_autotoc_md46}{}\doxyparagraph{Writing to the L\+L\+E\+MU}\label{llemu_autotoc_md46}
...
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the V5 Motors, see its \mbox{\hyperlink{group__c-motors}{C A\+PI}} and \mbox{\hyperlink{group__cpp-motors}{C++ A\+PI}}.
\end{DoxyNote}
...
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} easiest way to interact with the motors is through the \href{../../api/c/motors.html\#motor-move}{\texttt{ motor\+\_\+move}} function.\hypertarget{motors_autotoc_md50}{}\doxyparagraph{Autonomous Movement}\label{motors_autotoc_md50}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} V5 Motors can move in a number of different ways that are better suited towards autonomous movement than the simple {\ttfamily \mbox{\hyperlink{group__c-motors_gac14bccd595a812fff8c30d2d050844a9}{motor\+\_\+move()}}} example shown above.\hypertarget{motors_autotoc_md51}{}\doxysubparagraph{Profile Movements}\label{motors_autotoc_md51}
...
For further reading material on the algorithms that create these profiled movement, see \href{https://pdfs.semanticscholar.org/a229/fdba63d8d68abd09f70604d56cc07ee50f7d.pdf}{\texttt{ Mathematics of Motion Control Profiles}} for the \href{https://en.wikipedia.org/wiki/Feed_forward_(control)}{\texttt{ Feedforward}} control, and \href{http://georgegillard.com/documents/2-introduction-to-pid-controllers}{\texttt{ George Gillard\textquotesingle{}s P\+ID Explanation}} for the \href{https://en.wikipedia.org/wiki/Control_theory\#PID_feedback_control}{\texttt{ feedback}} control.\hypertarget{motors_autotoc_md52}{}\doxysubparagraph{Velocity Controller Movement}\label{motors_autotoc_md52}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} final {\ttfamily move} function available with the P\+R\+OS Motor A\+PI is {\ttfamily \mbox{\hyperlink{group__c-motors_ga2f3f7e0a243e9432b3d60e4b6147f177}{motor\+\_\+move\+\_\+velocity()}}}. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} ensures consistent velocity output from the motor through the use of \href{http://georgegillard.com/documents/2-introduction-to-pid-controllers}{\texttt{ P\+ID}}. \hypertarget{multitasking}{}\doxysubsection{Multitasking}\label{multitasking}
\begin{DoxyNote}{Note}
For a full list of functions for interacting with Tasks, see its \mbox{\hyperlink{group__c-rtos}{C A\+PI}} and \mbox{\hyperlink{group__cpp-rtos}{C++ A\+PI}}. Tasks are a great tool to do multiple things at once, but they can be difficult to use properly. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} most important thing to remember when using tasks is that tasks aren\textquotesingle{}t truly running in the background -\/ they are run one at a time and swapped out by the P\+R\+OS scheduler. If your task performs some repeated action (e.\+g. a {\ttfamily while} loop), you should include a {\ttfamily \mbox{\hyperlink{group__c-llemu_ga6a62f5325d65f95436762552df547d73}{delay()}}} or {\ttfamily \mbox{\hyperlink{group__c-llemu_ga151eaf730a10d101bff15013a76b9aa8}{task\+\_\+delay\+\_\+until()}}}. Without a {\ttfamily \mbox{\hyperlink{group__c-llemu_ga6a62f5325d65f95436762552df547d73}{delay()}}} statement, your task could starve the processor of resources and prevent the kernel from running properly.
\end{DoxyNote}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} P\+R\+OS task scheduler is a preemptive, priority-\/based, round-\/robin scheduler. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} means that tasks are preempted (interrupted) every millisecond to determine if another task ought to run. P\+R\+OS decides which task to run next based on all of the ready tasks\textquotesingle{} priorities.
...
\item \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} higher the priority, the more crucial the task is considered, and more C\+PU time will be awarded to the task. Ready tasks of higher priority will always run in preference to lower priority tasks.
\item Tasks of equal priority take preference when a task is preempted. In other words, if tasks A and B have equal priority, then when A is interrupted, B will run next, even if A is still eligible for execution. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} is called round-\/robin scheduling. 
\end{DoxyItemize}\end{quote}
\hypertarget{multitasking_autotoc_md53}{}\doxyparagraph{On the Abuse of Tasks}\label{multitasking_autotoc_md53}
Tasks are very often misused and abused in ways that make the P\+R\+OS kernel behave in unintended ways. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} following list are some commonly made mistakes and guidelines for using Tasks in P\+R\+OS.
...
\item It was mentioned above, but it\textquotesingle{}s important enough for a second mention\+: every tasks\textquotesingle{} loop should have a {\ttfamily \mbox{\hyperlink{group__c-llemu_ga6a62f5325d65f95436762552df547d73}{delay()}}} statement. 
\end{DoxyItemize}\end{quote}
...
Task notifications are a powerful new feature in P\+R\+OS 3 which allows direct-\/to-\/task synchronization. A full tutorial on task notifications can be found \mbox{\hyperlink{notifications}{Task Notifications}}. \hypertarget{notifications}{}\doxysubsection{Task Notifications}\label{notifications}
\begin{DoxyNote}{Note}
For a full list of functions for interacting with Tasks, see its \mbox{\hyperlink{group__c-rtos}{C A\+PI}} and \mbox{\hyperlink{group__cpp-rtos}{C++ A\+PI}}. Task notifications are a powerful new feature in P\+R\+OS 3 which allows direct-\/to-\/task synchronization. Each task has a 32-\/bit notification value. Each task can block on its own notification (wait for it to become non-\/zero) and any task can update the notification value. Task notifications have a broad range of applications, are simple to use, and have significant memory and speed advantages when compared to traditional semaphore-\/based synchronization mechanisms.
\end{DoxyNote}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} simplest application of task notifications does not care about the task notification value\+: \hypertarget{vision}{}\doxysubsection{Vision Sensor}\label{vision}
\begin{DoxyNote}{Note}
For a full list of functions for interacting with the V5 Vision Sensor, see its \mbox{\hyperlink{group__c-vision}{C A\+PI}} and \mbox{\hyperlink{group__cpp-vision}{C++ A\+PI}}.
\end{DoxyNote}
\hypertarget{vision_autotoc_md58}{}\doxyparagraph{Setting Signatures}\label{vision_autotoc_md58}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} first step to using the vision sensor is setting color signatures for the sensor to recognize as objects. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} is done through the V5 Vision Utility program.\hypertarget{vision_autotoc_md59}{}\doxyparagraph{Retrieving Objects}\label{vision_autotoc_md59}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} primary function of the vision sensor is returning objects, or blobs of color detected by the sensor. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} characteristics of an object are defined in \href{../../api/c/vision.html\#vision_object_s_t}{\texttt{ vision\+\_\+object\+\_\+s\+\_\+t}}.\hypertarget{vision_autotoc_md60}{}\doxysubparagraph{By Size}\label{vision_autotoc_md60}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} simplest way to interact with the vision sensor is to get an object by its size. 0 is the largest object detected by the sensor.\hypertarget{vision_autotoc_md61}{}\doxysubparagraph{By Signature}\label{vision_autotoc_md61}
If you have multiple signatures saved to the vision signature, you will most likely want to only look for objects of a particular signature. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} {\ttfamily get\+\_\+by\+\_\+sig()} function implements this functionality.\hypertarget{vision_autotoc_md62}{}\doxyparagraph{Changing the Object Coordinates}\label{vision_autotoc_md62}
Each returned object from the vision sensor comes with a set of coordinates telling where the object was found in the vision sensor\textquotesingle{}s field of view. \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} default behavior is to return the coordinates as a function of distance from the top left corner of the field of view -\/ so positive y is downward and positive x is right. With the P\+R\+OS A\+PI, you can change this behavior so that the center of the Field Of View is the (0,0) point for object coordinates. Positive y is still downward and positive x is still right, but negative y is upward of center and negative x is left of center in this configuration.\hypertarget{vision_autotoc_md63}{}\doxyparagraph{Exposure Setting}\label{vision_autotoc_md63}
...
Since hot/cold linking involves ensuring two compiled programs interact consistently, there may be additional runtime issues running in this mode. \mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} section serves as a guide for debugging these sorts of issues.
