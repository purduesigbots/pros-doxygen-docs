...
\hypertarget{md_docs_tutorials_topical_motors_autotoc_md58}{}\doxysection{Initialization}\label{md_docs_tutorials_topical_motors_autotoc_md58}
...
\end{quote}
\end{quote}
\hypertarget{md_docs_tutorials_topical_motors_autotoc_md59}{}\doxysection{Simple Usage}\label{md_docs_tutorials_topical_motors_autotoc_md59}
The easiest way to interact with the motors is through the \href{../../api/c/motors.html\#motor-move}{\texttt{ motor\+\_\+move}} function. This is analogous to the \href{../../../cortex/api/index.html\#motorSet}{\texttt{ motor\+Set}} function from P\+R\+OS 2.\hypertarget{md_docs_tutorials_topical_motors_autotoc_md60}{}\doxysection{Autonomous Movement}\label{md_docs_tutorials_topical_motors_autotoc_md60}
The V5 Motors can move in a number of different ways that are better suited towards autonomous movement than the simple {\ttfamily \mbox{\hyperlink{motors_8h_a7da9bf1e229e50bfeeaecf026a6d0d08}{motor\+\_\+move()}}} example shown above.\hypertarget{md_docs_tutorials_topical_motors_autotoc_md61}{}\doxysubsection{Profile Movements}\label{md_docs_tutorials_topical_motors_autotoc_md61}
