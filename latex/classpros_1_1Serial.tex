...
\hline
{\em baudrate} & \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} baudrate to run the port at \\
\hline
\end{DoxyParams}
...
\begin{DoxyReturn}{Returns}
\mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} serial port\textquotesingle{}s port number. 
\end{DoxyReturn}
