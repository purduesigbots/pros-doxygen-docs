...
If you find doing \mbox{\hyperlink{classpros_1_1Motor}{pros\+::\+Motor()}} to be tedious and you\textquotesingle{}d prefer just to do Motor, you can use the namespace with the following commented out line.
