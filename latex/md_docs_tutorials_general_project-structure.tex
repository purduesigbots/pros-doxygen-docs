P\+R\+OS projects are internally composed of three parts\+: the {\bfseries{P\+R\+OS library}} (found in {\ttfamily /firmware}), the {\bfseries{header}} files (found in {\ttfamily /include}), and {\bfseries{user code}} (found in {\ttfamily /src}).\hypertarget{md_docs_tutorials_general_project-structure_autotoc_md31}{}\doxysection{firmware}\label{md_docs_tutorials_general_project-structure_autotoc_md31}
The {\bfseries{P\+R\+OS library}} is a single file containing the core P\+R\+OS routines. This file does not need to be changed. If there appears to be an issue with a core P\+R\+OS function, please file an issue on \href{https://github.com/purduesigbots/pros/issues}{\texttt{ Git\+Hub}}.\hypertarget{md_docs_tutorials_general_project-structure_autotoc_md32}{}\doxysection{include}\label{md_docs_tutorials_general_project-structure_autotoc_md32}
