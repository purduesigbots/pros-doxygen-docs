\hypertarget{md_docs_tutorials_general_usage-faq_autotoc_md35}{}\doxysection{Why do I get a \char`\"{}\+Could not open port\char`\"{} error when flashing?}\label{md_docs_tutorials_general_usage-faq_autotoc_md35}
