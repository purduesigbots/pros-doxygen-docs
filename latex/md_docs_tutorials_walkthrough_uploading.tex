/page uploading Uploading\hypertarget{md_docs_tutorials_walkthrough_uploading_autotoc_md83}{}\doxysubsection{Uploading}\label{md_docs_tutorials_walkthrough_uploading_autotoc_md83}
\hypertarget{md_docs_tutorials_walkthrough_uploading_autotoc_md84}{}\doxysubsection{Uploading from within the Editor}\label{md_docs_tutorials_walkthrough_uploading_autotoc_md84}
...
\end{DoxyItemize}\hypertarget{md_docs_tutorials_walkthrough_uploading_autotoc_md85}{}\doxysubsection{Uploading through the P\+R\+O\+S C\+LI}\label{md_docs_tutorials_walkthrough_uploading_autotoc_md85}

\begin{DoxyItemize}
\item Running {\ttfamily pros upload} on the command line will upload your project to the V5 brain.
\end{DoxyItemize}\hypertarget{md_docs_tutorials_walkthrough_uploading_autotoc_md86}{}\doxysubsection{Wireless Upload}\label{md_docs_tutorials_walkthrough_uploading_autotoc_md86}
To see more details on how to wireless upload see \mbox{\hyperlink{wireless-upload}{Wireless Upload and Hot/\+Cold Linking}} \hypertarget{wireless-upload}{}\doxysection{Wireless Upload and Hot/\+Cold Linking}\label{wireless-upload}
\begin{DoxyNote}{Note}
...
\end{DoxyCode}
\hypertarget{wireless-upload_autotoc_md68}{}\doxysubsubsection{Hot/\+Cold Linking Troubleshooting}\label{wireless-upload_autotoc_md68}
