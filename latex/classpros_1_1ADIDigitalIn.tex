...
\mbox{\hyperlink{namespace_3globalScope_4_structThis}{This}} function uses the following values of errno when an error state is reached\+:

E\+A\+D\+D\+R\+I\+N\+U\+SE -\/ \mbox{\hyperlink{namespace_3globalScope_4_structThe}{The}} port is not configured as a digital input (e.\+g. the port has been reconfigured)
