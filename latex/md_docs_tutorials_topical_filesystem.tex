...
\end{DoxyCode}
\hypertarget{md_docs_tutorials_topical_filesystem_autotoc_md50}{}\doxysection{Remarks}\label{md_docs_tutorials_topical_filesystem_autotoc_md50}
The micro\+SD card must be fat32 in order to work.\hypertarget{md_docs_tutorials_topical_filesystem_autotoc_md51}{}\doxysubsection{Serial}\label{md_docs_tutorials_topical_filesystem_autotoc_md51}
